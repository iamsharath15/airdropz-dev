      ...
      <div className="flex justify-between items-center mb-6">
        <div className="relative w-full max-w-md">
          ...
          <Input
            ...
            className="pl-10 bg-gray-900 border-gray-700 text-white py-6 rounded-lg"
          />
        </div>
        <div className="flex gap-4">
          <Button variant="outline" className="gap-2 text-gray-300 border-gray-700 bg-gray-900">
            <LayoutGrid size={18} />
            Category
          </Button>
          <Button variant="outline" className="gap-2 text-gray-300 border-gray-700 bg-gray-900">
